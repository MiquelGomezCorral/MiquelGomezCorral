...
## 💫 About Me:
I am a Computer Engineer with a Master's in AI, Digital Image, and Natural Language from Universitat Politècnica de València (UPV).<br><br>🎯 Passionate about AI & Machine Learning—currently working as an **AI Automation Engineer**, building and orchestrating agents (MCP, tool-use), optimizing RAG systems, and integrating LLMs to solve real-world problems.<br>👾 AmmaCodeLikeNoOneMama<br>🌐 Bilingual (Spanish & Valencian), Advanced English (B2-level Cambridge certified).
...
[![Portfolio Website](https://img.shields.io/badge/Portfolio-Website-blue?style=flat&logo=google-chrome)](https://miquelgc.net)  
